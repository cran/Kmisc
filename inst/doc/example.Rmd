...
dat2 <- data.frame( id=c(1, 2, 3), z=rnorm(3) )
...
## I set the res high because otherwise png's look like
## garbage on a retina display
hImg( file="test.png", width=4, height=3,
      xyplot( y ~ x, col=kColor(x+y) )
      )
hSvg( file="test.svg", width=4, height=3,
      xyplot( y ~ x, col=kColor(x+y) )
      )
```
